// =============================================================
// api/onboarding.js — TOUT-EN-UN (1 seul fichier, 1 seule URL)
//
// URL principale (webhook monday, POST) :
//   https://ton-projet.vercel.app/api/onboarding
//
// Outils de debug (GET, via ?action=...) :
//   /api/onboarding?action=setup-webhook
//   /api/onboarding?action=check-formation-index
//   /api/onboarding?action=test-reservation&itemId=XXXXX
// =============================================================
